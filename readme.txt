...
-------------------------------------------
Grade Calculator is a simple tool that allows an instructor from Hunter College's CSCI 13500 course to obtain a student's information and calculate the overall grade they will receive
...
Additional Notes: 
- In order for the file to work properly, the instructor must enter the student's information and grades accordingly to the sample CSV file, which will be provided as "grades.csv". 
- For any grade category that you do not have values for, enter 0.
...
1. Download the files: 
    ...
    - class.hpp
    - class.cpp
    - grades.csv [Note: this csv file can be replaced with your own csv file filled with the student's information and grades]
2. Open the terminal and copy and paste the following line: 
    g++ main.cpp student.cpp grades.cpp class.cpp && ./a.out
...
3. If you chosen to enter the student's first and last name, the program will ask for the first name first, and then the last name (DO NOT ENTER THE FULL NAME).
   If you chosen to enter the student's ID, enter the student's ID.
